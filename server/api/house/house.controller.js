...
export function index(req, res) {
  return House.find().populate('team commander').exec()
...
export function show(req, res) {
  return House.findById(req.params.id).populate('team').exec()
...
export function addNextMem(j,i, house){
...
export function patch(req, res) {
  ...
  return House.findById(req.params.id).exec()
    .then(handleEntityNotFound(res))
